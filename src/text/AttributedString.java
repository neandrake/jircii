...
public class AttributedString {
	...
	/** constant for defacto irc standard bold character */
	public static final char underline = (char) 31;
	/** constant for defacto irc standard underline character */
	public static final char color = (char) 3;
	/** constant for defacto irc standard color character (thanks mIRC) */
	public static final char cancel = (char) 15;
	/** constant for defacto irc standard cancel character */
	public static final char reverse = (char) 22;
	/** constant for defacto irc standard reverse character */
	public static final char tab = '\t';
	/** constant for beloved tab character */
	...
	/**
	 * constructor called for an already parsed attributed string, if you want to create a new object use
	...
	/*
	 * protected void finalize() { total_instances--; }
	 */
