...
import rero.client.functions.ChannelOperators; // built in functions
...
import rero.client.listeners.InternalEvents; // misc. built in client events.  fun fun.
...
public class Capabilities {
	...
	public Capabilities(ChatFramework _ircfw, SocketConnection _socket, ScriptCore _script, UICapabilities _gui, WeakHashMap _data) {
		...
		ProcessEvents processEvents = new ProcessEvents(); // process some basic sets from the server i.e. DCC before
															// everyone e$
