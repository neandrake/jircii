...
public class ChannelOperators extends Feature implements Predicate, Function, Loadable {
	...
	public void scriptLoaded(ScriptInstance script) {
		String[] contents = new String[] { "ison", /** predicates */
		"isop", "ishalfop", "isvoice", "isnormal", "ismode", "hasmode", "&getUsers", /** functions that return an array value */
		"&getOps", "&getHalfOps", "&getVoiced", "&getNormal", "&getTopic", /** functions that return a normal scalar value */
		"&getKey", "&getMode", "&getLimit", "&getModeFor", "&getModeChars" };
