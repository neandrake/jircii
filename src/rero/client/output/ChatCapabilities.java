...
public class ChatCapabilities extends Feature {
	 ...
	 * parameter. It was initially implemented for use by VelocityEmail. If there are tabs in inString, you are going to get
	 * results that are a bit strange, since tabs are a single character but are displayed as 4 or 8 spaces. Remove the tabs.
	 * 
	 * @param inString
	...
	/**
	 * Wraps a single line of text. Called by wrapText(). I can't think of any good reason for exposing this to the public,
	...
	/*
	 * public static void main(String[] args) { String[] strings = wrapMessageToStringsArray("alpha beta gamma someshit", 6);
	 * for (int i = 0; i < strings.length; i++) { String string = strings[i]; System.out.println("string = " + string); } }
	 */
}
