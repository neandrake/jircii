...
import rero.gui.script.WindowDataListener; // for the WindowDataListener
...
public class UICapabilities {
	...
	/**
	 * prints text to all open windows for the current server. By all I mean *all* open windows. Window buttons are not
	 * flagged.
	 */
