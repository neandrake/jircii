...
public class AboutWindow extends StatusWindow implements Runnable {
	...
	private static class UserModel extends AbstractListModel {
		...
		public void setUsers(String[] _users) {
			users = _users;
			fireContentsChanged(this, 0, users.length);
		}
	...
	public void bkow() {
		...
		JScrollPane scroller = new JScrollPane(lusers, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
