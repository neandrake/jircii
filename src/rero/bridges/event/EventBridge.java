...
/**
 * Man, I feel bad for the mantainer of this class. Oh wait thats me. Actually its not that bad. However this class isn't
 * just as straight forward as registering any kind of event and going with it one way. Nope, there are 3 ways events can be
 * handled.
 * 
 * <pre>
...
public class EventBridge implements Loadable, Environment, PredicateEnvironment, FilterEnvironment {
	...
	public void bindFilteredFunction(ScriptInstance si, String typeKeyword, String keyword, String filter, Block functionBody) {
		...
		if (typeKeyword.equals("on")) {
			framework.addChatListener(temp);
		}
