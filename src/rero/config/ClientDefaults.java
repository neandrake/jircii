...
public class ClientDefaults {
	...
	public static final boolean ident_enabled = (System.getProperty("os.name").indexOf("Window") > -1) ? true : false; // by
																														// default
																														// enable
																														// ident
																														// on
	...
	public static final boolean ui_showrestart = true; // show warning dialog notifying a user restart is required for
