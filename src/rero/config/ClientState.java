...
public class ClientState {
	...
	/**
	 * performs a backup of the properties before making changes, it is the responsability of the changing class to call this
	 * function
	 */
	public void backup() {
	...
	/**
	 * performs a restore of the properties effectively undoing everything since the last backup, it is the responsability of
	 * the changing class to call this function
	 */
	public void restore() {
		state = backup;
		sync();
	...
	public void setColor(String key, Color color) {
		/*
		 * long value = 0; value = (color.getRed() << 16) | value; value = (color.getGreen() << 8) | value; value =
		 * (color.getBlue() << 0) | value;
		 */
	...
	// TODO: These will be per-operating system; right now it does just OS X, but it will also check the value for Windows
	// and Linux.
