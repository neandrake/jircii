...
public class ChatFramework {
	...
	/**
	 * Injects a string into the data stream as if it came from the server. parsed in the same manner. format should be
	 * :nick!user@host EVENT_NAME target :parameters just like the irc protocol. Since jIRC handles everything in a generic
	 * way, client events will be more uniform with this system
	 */
