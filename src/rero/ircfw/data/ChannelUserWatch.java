...
public class ChannelUserWatch extends DataEventAction implements FrameworkConstants {
	...
	public boolean isEvent(HashMap data) {
		...
		return (event.equals("QUIT") || event.equals("JOIN") || event.equals("PART") || event.equals("NICK") || event.equals("KICK") || event.equals("PRIVMSG"));
	}
...
/*
 * Enter String> :theUncle!~a@pcp.royalok.mi.comcast.net NICK :^butane** looking at: :^butane Parsing message took: 8 user =
 * ~a data = <null> ^butane host = pcp.royalok.mi.comcast.net address = ~a@pcp.royalok.mi.comcast.net event = NICK source =
 * theUncle nick = theUncle raw = :theUncle!~a@pcp.royalok.mi.comcast.net NICK :^butane parms = ^butane
 * 
 * Enter String> :cheezi!chris@likes.dick.com KICK #pollution ^butane :I am the uncle** looking at: ^butane :I am the uncle**
 * looking at: :I am the uncle Parsing message took: 2 user = chris data = #pollution ^butane I am the uncle target =
 * #pollution host = likes.dick.com address = chris@likes.dick.com event = KICK source = cheezi nick = cheezi raw =
 * :cheezi!chris@likes.dick.com KICK #pollution ^butane :I am the uncle parms = ^butane I am the uncle
 */
