...
/**
 * This class is a mode interpreter for each server. Basically each server can have channel user prefix modes. The state of
 * these modes is stored as an int within each User object (associated in a hashmap with the Channel object as the key). This
 * class is used to make sense of the integer mode value for a given servers configuration
 */
