...
public class Send extends ProtocolDCC {
	...
	/**
	 * Create a ready to rock and roll receive socket. It is assumed that the File object is either cleared or ready to be
	 * resumed. An overwrite command should delete the file first and then start dumping to it. Hopefully this is a safe way
	 * to go. Eh?
	 */
