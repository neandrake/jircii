...
public class OptionWindow extends JDialog implements DCapabilities, TreeSelectionListener {
	...
	public void buildTables() {
		...
		category = new DefaultMutableTreeNode("Setup");
		items.add(category);
		option = new DefaultMutableTreeNode(addDialog(current));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new IdentDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new ProxyDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new PerformDialog()));
		category.add(option);

		category = new DefaultMutableTreeNode("Client Options");
		items.add(category);
		option = new DefaultMutableTreeNode(addDialog(new IRCOptions()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new ClientOptions()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new DCCOptions()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new LoggingDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new AutoWindowDialog()));
		category.add(option);

		category = new DefaultMutableTreeNode("Scripts");
		items.add(category);
		option = new DefaultMutableTreeNode(addDialog(new ScriptDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new ThemeDialog()));
		category.add(option);

		category = new DefaultMutableTreeNode("User Lists");
		items.add(category);
		option = new DefaultMutableTreeNode(addDialog(new NotifyDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new IgnoreDialog()));
		category.add(option);

		category = new DefaultMutableTreeNode("Interface Options");
		items.add(category);
		option = new DefaultMutableTreeNode(addDialog(new UIDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new FontDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new SwitchBarDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new WindowsDialog()));
		category.add(option);
		option = new DefaultMutableTreeNode(addDialog(new ImageDialog()));
		category.add(option);
	...
	private OptionWindow(Frame frame) {
		...
		genScroller.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
		genScroller.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
